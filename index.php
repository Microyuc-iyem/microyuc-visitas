    ...
    <div class="letterGeneratorForm__container">
        ...
        <form class="letterGeneratorForm" action="./exportar.php" method="post">
            <div>
                ...
                <input class="letterGeneratorForm__input" type="text" id="numero_expediente" name="numero_expediente" required>
            </div>
            <div>
                <label for="nombre_cliente">Nombre del cliente<span class="asterisk">*</span>: </label>
                <input class="letterGeneratorForm__input" type="text" id="nombre_cliente" name="nombre_cliente" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input class="letterGeneratorForm__input" type="number" id="numero_direccion" name="numero_direccion">
            </div>
            <div>
            ...
            <div>
                ...
                <input class="letterGeneratorForm__input" type="text" id="tipo_credito" name="tipo_credito" required>
            </div>
            <div>
                <label for="fecha_otorgamiento">Fecha de otorgamiento del crédito<span class="asterisk">*</span>:
                </label>
                <input class="letterGeneratorForm__input" type="date" id="fecha_otorgamiento" name="fecha_otorgamiento" required>
            </div>
            <div>
                <label for="monto_inicial">Monto inicial<span class="asterisk">*</span>: </label>
                <input class="letterGeneratorForm__input" type="number" id="monto_inicial" name="monto_inicial" required>
            </div>
            <div>
                <label for="mensualidades_vencidas">Mensualidades vencidas<span class="asterisk">*</span>: </label>
                <input class="letterGeneratorForm__input" type="number" id="mensualidades_vencidas" name="mensualidades_vencidas"
                       required>
            </div>
            <div>
