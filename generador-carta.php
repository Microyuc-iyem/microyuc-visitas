...
// Formatear la fecha con el nombre del mes en español
$fecha_visita_formatted = $fecha_visita->format('j \de F \de Y');

// Reemplazar el día y el año en la cadena formateada
$fecha_visita_formatted = preg_replace('/([0-9]{1,2}) de ([A-Za-z]+) de ([0-9]{4})/', '$1 de $2 de $3', $fecha_visita_formatted);
